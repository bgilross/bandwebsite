...
export default function Contact() {
  ...
  return (
    <div className='min-h-screen w-full flex justify-center items-center'>
      <div
        className={`w-[500px] h-[500px] flex flex-col justify-center items-center rounded-xl py-8 ${bevan.className}`}
      >
        ...
        >
          ...
          <textarea className='input-style' id='text' rows={5} name='message' />
          <input
